...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      entries => {
        inViewRef.current = true; // Force true to prevent transform issues
      },
  ...
  return (
    <div 
      ...
      style={{ width: '100%', height: '100%', position: 'relative', pointerEvents: 'none', mixBlendMode: 'screen', ...style }}
    />
  );
};
